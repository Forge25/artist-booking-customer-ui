...
export default function HeroSection() {
  return (
    <div className="flex rounded-2xl overflow-hidden mt-4 h-[230px]">
      {/* Left: Concert image with overlay */}
      <div
        className="flex-1 relative bg-cover bg-center flex flex-col justify-end p-8"
        style={{ backgroundImage: "url('/person.png')" }}
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/75 text-sm mt-2 max-w-sm leading-relaxed">
      ...
      <div className="w-[260px] bg-white px-5 py-5 flex-shrink-0">
        <h3 className="font-semibold text-gray-900 mb-4 text-sm">Popular Artist</h3>
        <div className="space-y-3">
          {popularArtists.map((artist, i) => (
            <div key={i} className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full overflow-hidden flex-shrink-0 ring-1 ring-gray-100">
